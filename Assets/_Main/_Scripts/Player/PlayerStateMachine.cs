...
public class PlayerStateMachine : MonoBehaviour
{
    ...
    {
        var idle = new PlayerIdleState<PlayerStates>(OnIdleCommand, PlayerStates.Sailing,PlayerStates.Fishing ,_playerInputs);
        var sail = new PlayerSailState<PlayerStates>(OnMoveCommand, PlayerStates.Idle,PlayerStates.Fishing, _playerInputs);
